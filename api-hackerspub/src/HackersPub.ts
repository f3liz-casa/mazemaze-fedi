...
export function close(_c: HackersPubClient): void {}
...
export interface CreateNoteInput {
  ...
  media?: Array<{ mediumId: string; alt: string }>;
...
export function publicTimeline(
  ...
  return gql(
    c,
    `query PublicTimeline($after:String,$first:Int,$languages:[Locale!],$withoutShares:Boolean){
...
export function personalTimeline(
  ...
  return gql(
    c,
    `query PersonalTimeline($after:String,$first:Int,$languages:[Locale!],$withoutShares:Boolean){
...
export function actorByHandle(
  c: HackersPubClient,
  req: { handle: string; allowLocalHandle?: boolean }
): Promise<unknown> {
  return gql(
    c,
...
export function accountByUsername(
  c: HackersPubClient,
  req: { username: string }
): Promise<unknown> {
  return gql(
...
export function viewer(c: HackersPubClient): Promise<unknown> {
  return gql(
    c,
    `query Viewer{
      viewer{
...
export function postReplies(
  c: HackersPubClient,
  req: { id: string; after?: string; first?: number }
): Promise<unknown> {
  return gql(
    c,
...
export function actorPosts(
  c: HackersPubClient,
  req: { handle: string; after?: string; first?: number }
): Promise<unknown> {
  return gql(
    c,
...
export function actorPostsById(
  c: HackersPubClient,
  req: { id: string; after?: string; first?: number }
): Promise<unknown> {
  return gql(
    c,
    `query ActorPostsById($id:ID!,$after:String,$first:Int){
      node(id:$id){
        __typename
        ... on Actor {
          id handle name avatarUrl
...
export function addReaction(
  ...
  return gql(
    c,
    `mutation AddReaction($input:AddReactionToPostInput!){
...
export function removeReaction(
  ...
  return gql(
    c,
    `mutation RemoveReaction($input:RemoveReactionFromPostInput!){
...
export function unbookmarkPost(
  c: HackersPubClient,
  input: UnbookmarkPostInput
): Promise<unknown> {
  return gql(
    c,
    `mutation UnbookmarkPost($input:UnbookmarkPostInput!){
...
export function unsharePost(
  c: HackersPubClient,
  input: UnsharePostInput
): Promise<unknown> {
  return gql(
    c,
    `mutation UnsharePost($input:UnsharePostInput!){
...
export function followActor(
  ...
  return gql(
    c,
    `mutation FollowActor($input:FollowActorInput!){
...
export function unfollowActor(
  c: HackersPubClient,
  input: UnfollowActorInput
): Promise<unknown> {
  return gql(
    c,
    `mutation UnfollowActor($input:UnfollowActorInput!){
...
export function voteOnPoll(
  ...
  return gql(
    c,
    `mutation VoteOnPoll($input:VoteOnPollInput!){
...
export function startMediumUpload(
  c: HackersPubClient,
...
export function finishMediumUpload(
  c: HackersPubClient,
...
export function markNotificationsAsRead(
  ...
  return gql(
    c,
    `mutation MarkNotificationsAsRead($upTo:UUID){markNotificationsAsRead(upTo:$upTo)}`,
    req
  );
}
...
export function loginByUsername(
  c: HackersPubClient,
  req: { username: string; locale: string; verifyUrl: string }
): Promise<unknown> {
  return gql(
    c,
...
export function loginByEmail(
  c: HackersPubClient,
  req: { email: string; locale: string; verifyUrl: string }
): Promise<unknown> {
  return gql(
    c,
